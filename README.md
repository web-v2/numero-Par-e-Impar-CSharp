...
# Comprobar si un numero ingresado es PAR o IMPAR C#

_Mediante el siguiente proyecto se verifica si un numero ingresado en una caja de texto es PAR o IMPAR con Windows App Form C#_
